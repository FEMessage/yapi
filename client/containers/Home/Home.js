  ...
  <div className="g-body">
    ...
    <div className="feat-part section-feature">
      <div className="container home-section">
        ...
        <span className="desc">
          DApi让接口开发更简单高效，让接口的管理更具可读性、可维护性，让团队协作更合理。
        </span>
      ...
      <div className="container">
        <Row className="row-card" style={{ marginBottom: '.48rem' }}>
          ...
          <Col lg={17} xs={14} className="section-card manage-word">
            ...
            <p className="desc">
              DAPI
              将扁平化管理模式的思想引入到产品的权限管理中，超级管理员拥有最高的权限，并将权限分配给若干组长，超级管理员只需管理组长即可，实际上管理DAPI各大分组与项目的是“组长”。组长对分组或项目负责，一般由BU负责人/项目负责人担任。
            </p>
          </Col>
        </Row>
      </div>
